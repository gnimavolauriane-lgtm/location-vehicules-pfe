...
<body>
    ...
    <section class="section-llc" id="llc-section">
        <h2 id="main-title">Les avantages de la location longue durée (LLD)</h2>
        ...
        <div class="content-display" id="display-area">
            ...
            <div class="content-img">
                <img src="image/blog/budget.jpg" alt="Budget maîtrisé" />
            </div>
        </div>

        <div class="grid-cards" id="cards-container">
            <div class="card active" data-id="1"><h3>Budget maîtrisé</h3></div>
            <div class="card" data-id="2"><h3>Véhicule récent</h3></div>
            <div class="card" data-id="3"><h3>Entretien inclus</h3></div>
            <div class="card" data-id="4"><h3>Flexibilité totale</h3></div>
        </div>
    </section>
...
<script>
    ...
    const sectionsData = {
        1: {
            ...
            description: "Avec la LLD, vous payez un loyer fixe chaque mois, sans surprise. L’assurance, l’entretien, et même l’assistance peuvent être inclus dans votre contrat.",
            imgSrc: "image/blog/budget.jpg",
            imgAlt: "Budget maîtrisé"
        },
        2: {
            title: "Véhicule récent",
            description: "Profitez d’un véhicule récent et toujours en parfait état, pour plus de sécurité et de confort lors de vos déplacements.",
        ...
        3: {
            ...
            description: "L’entretien et les réparations sont pris en charge par le loueur, vous n’avez donc pas de souci à vous faire sur les frais imprévus.",
            imgSrc: "image/blog/entretien.jpg",
            imgAlt: "Entretien inclus"
        },
        4: {
            title: "Flexibilité totale",
            description: "Adaptez la durée et les options de votre contrat selon vos besoins, avec la possibilité de changer de véhicule en cours de contrat.",
