...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture Renault New Express van 3-5m³ BVM</p>
    <h2 class='lien1-texte'>Location Renault New Express van 3-5m³ BVM</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image utilitaire/express.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VPIW)</h2>
        <p class='Voiture-description'>Renault New Express van 3-5m³ BVM</p>
        <p class='detailVoiture-description'>Gasoil|BV Manuelle|2 passagers|4 portes|6 Ch.Fisc|Volume 4m³|A/C: Oui|GPS: Non </p> 
