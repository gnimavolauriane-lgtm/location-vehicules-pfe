...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Mitsubishi L200 Hardtop-Offre spéciale à 100 kms/jr (cat IQND)</p>
    <h2 class='lien1-texte'>Louer une voiture Mitsubishi L200 Hardtop -Offre spéciale à 100 kms/jr (cat IQND) </h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image SUV/hardtop_L200.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(IQND)</h2>
        <p class='Voiture-description'>Mitsubishi L200 Hardtop 4X4</p>
        <p class='detailVoiture-description'>Gasoil | BV Automatique | 7 passagers | 5 portes | 3 valises | 6 sacs | 9 Ch. Fisc. | A/C : Oui | GPS : Non </p> 
 ...
 <div class="titretexte">
       <div class="titretexte-contenu">
          <p>Services inclus <br>Kilométrage limité à 100 Kms / Jour, TVA de 20%, Responsabilité Civile, Assistance routière 24/7, Surcharge Gare, Assurance CDW et TP avec Franchise.  <br> Franchises et cautions <br>Franchise accident: 14 400,00 DH, Franchise vol: 14 400,00 DH, Caution: 14 400 DH<br> Pré-requis <br>Âge minimum: 23 ans, Année de permis minimum: 2 an(s)</p>
