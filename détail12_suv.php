...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Geely Coolray BVA-Offre en KM illimité (cat IXAR)</p>
    <h2 class='lien1-texte'>Louer une voiture Geely Coolray BVA-Offre en KM illimité (cat IXAR) </h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image SUV/geely.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(IXAR)</h2>
        <p class='Voiture-description'>Geely Coolray</p>
