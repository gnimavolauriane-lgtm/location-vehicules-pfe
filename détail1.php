...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture KIA Picanto</p>
    <h2 class='lien1-texte'>Louer une voiture KIA Picanto</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/picanto.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Toutes Catégories(MDMR)</h2>
        <p class='Voiture-description'>KIA Picanto</p>
        <p class='detailVoiture-description'>Essence | BV Manuelle | 4 passagers | 5 portes | 1 valise | 2 sacs | 6 Ch. Fisc. | A/C : Oui | GPS : Non </p>
