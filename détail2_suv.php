...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Dacia Duster-Offre spéciale à 100 kms/jr (cat IFMN)</p>
    <h2 class='lien1-texte'>Louer une voiture Dacia Duster (cat:IFMR) </h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image compacte/Dacia Duster.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(IFMR)</h2>
        <p class='Voiture-description'>Dacia Duster 2WD</p>
