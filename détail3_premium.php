...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "PREMIUM"  </a> >
     <p class='lien1-description'>Louer une voiture Volkswagen Touareg BVA</p>
    <h2 class='lien1-texte'>Louer une voiture Volkswagen Touareg BVA- Offre en KM illimité (cat XFAD)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image Premium/AWD.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie PREMIUM(XFAD)</h2>
        <p class='Voiture-description'>Volkswagen Touareg BVA</p>
        <p class='detailVoiture-description'>Gasoil|BV Automatique|5 passagers|5 portes|3 valises |6 Sacs|12 Ch.Fisc|A/C: Oui|GPS: Non </p> 
