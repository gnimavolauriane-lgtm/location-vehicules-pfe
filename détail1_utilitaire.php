...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture Peugeot Expert L1H1/p>
    <h2 class='lien1-texte'>Location Peugeot Expert L1H1</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image utilitaire/L1H1.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VMIW)</h2>
        <p class='Voiture-description'>Peugeot Expert L1H1</p>
        <p class='detailVoiture-description'>Gasoil|BV Manuelle|3 passagers|4 portes|9 Ch.Fisc|Volume 8m³|A/C: Oui|GPS: Non </p> 
