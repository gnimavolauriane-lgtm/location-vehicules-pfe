...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture Kia K2500 Pick Up -Offre à 100Kms/Jour (cat:VGXP)</p>
    <h2 class='lien1-texte'>Louer une voiture Kia K2500 Pick Up -Offre à 100Kms/Jour (cat:VGXP)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image utilitaire/KIA K2700.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VGXP)</h2>
        <p class='Voiture-description'>KIA K2500 plateau à ridelles</p>
        <p class='detailVoiture-description'>Gasoil|BV Manuelle|3 passagers|2 portes|10 Ch.Fisc|Volume 12m³|A/C: Oui|GPS: Non </p> 
