...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture Fiat Tipo(EDMD)</p>
    <h2 class='lien1-texte'>Louer une voiture Fiat Tipo(EDMD)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/Fiat.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(ECMN)</h2>
        <p class='Voiture-description'>Fiat Tipo (EDMD)</</p>
