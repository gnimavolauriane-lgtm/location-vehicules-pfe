...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture KIA K2500 Frigo Négatif -Offre à 100Kms/Jour (cat:VGXF)</p>
    <h2 class='lien1-texte'>Louer une voiture KIA K2500 Frigo Négatif  -Offre à 100Kms/Jour (cat:VGXF)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image utilitaire/camion.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VGXF)</h2>
        <p class='Voiture-description'>KIA K2500 Frigo Négatif</p>
