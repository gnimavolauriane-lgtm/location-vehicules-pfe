...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture Fiat 500X(ECAN)</p>
    <h2 class='lien1-texte'>Louer une voiture Fiat 500X(ECAN)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/Fiat 500X.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(ECMN)</h2>
        <p class='Voiture-description'>Fiat 500X (ECAN)</</p>
        <p class='detailVoiture-description'>Essence | BV Automatique | 4 passagers | 5 portes | 2 valises | 2 sacs | 6 Ch. Fisc. | A/C : Oui | GPS : Non </p>
