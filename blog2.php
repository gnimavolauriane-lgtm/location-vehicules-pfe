...
<body>
    ...
    <section class="section-llc" id="llc-section">
        <h2 id="main-title">Comment bien choisir son modèle de voiture</h2>

        <div class="content-display" id="display-area">
            <div class="content-text">
                <h4>Définir besoins d'usage</h4>
                <p>Pourquoi c’est important :
            Choisir un modèle adapté à son quotidien permet d’économiser sur l’achat, l’entretien et le carburant.
            Ce qu’il faut considérer :

            Usage urbain ? Privilégie une citadine compacte (ex. : Renault Clio, Peugeot 208).

            Longs trajets réguliers ? Opte pour une berline confortable ou une routière.

            Famille nombreuse ? Un monospace ou SUV avec grand coffre est plus adapté.

            Loisirs ou tout-terrain ? SUV ou 4x4 selon le terrain et les activités.
        </p>
            </div>
            <div class="content-img">
                <img src="image/blog/besoin.jpg" alt="Budget maîtrisé" />
            </div>
        </div>

        <div class="grid-cards" id="cards-container">
            <div class="card active" data-id="1"><h3>Définir besoins d'usage</h3></div>
            <div class="card" data-id="2"><h3>Choisir bonne motorisation</h3></div>
            <div class="card" data-id="3"><h3>Tenir compte taille</h3></div>
            <div class="card" data-id="4"><h3>Evaluer le TCO</h3></div>
        </div>
    </section>
...
<script>
    ...
    const sectionsData = {
        1: {
            title: "Définir besoins d'usage",
            description: "Pourquoi c’est important :Choisir un modèle adapté à son quotidien permet d’économiser sur l’achat, l’entretien et le carburant.Ce qu’il faut considérer :Usage urbain ? Privilégie une citadine compacte (ex. : Renault Clio, Peugeot 208).Longs trajets réguliers ? Opte pour une berline confortable ou une routière.Famille nombreuse ? Un monospace ou SUV avec grand coffre est plus adapté.Loisirs ou tout-terrain ? SUV ou 4x4 selon le terrain et les activités.",
            imgSrc: "image/blog/besoin.jpg",
            imgAlt: "Budget maîtrisé"
        },
        2: {
            title: "Choisir bonne motorisation",
            description: "Pourquoi c’est important Chaque motorisation a ses avantages selon le kilométrage, l'écologie et le coût.Exemples :Essence : Moins cher à l’achat, idéal pour de petits trajets.Diesel : Rentable si > 20 000 km/an, mais entretien plus coûteux.Hybride/Hybride rechargeable : Bon compromis pour la ville et les trajets mixtes.Électrique : Zéro émission, recharge à domicile, mais autonomie et bornes à considérer.",
            imgSrc: "https://images.unsplash.com/photo-1503376780353-7e6692767b70?auto=format&fit=crop&w=700&q=60",
            imgAlt: "Véhicule récent"
        },
        3: {
            title: "Tenir compte taille",
            description: "Pourquoi c’est important :Un véhicule trop grand peut être contraignant en ville ou dans les parkings étroits.À analyser :Dimensions du garage ou parking Fréquence de stationnement en ville Maniabilité (rayon de braquage, caméras de recul, capteurs, etc. ➡ Un petit SUV peut être un bon compromis entre espace intérieur et compacité extérieure.",
            imgSrc: "image/blog/taille.jpg",
            imgAlt: "Entretien inclus"
        },
        4: {
            title: "Evaluer le TCO",
            description: "Pourquoi c’est important :Le prix d’achat ne fait pas tout : il faut penser au coût global sur la durée.À inclure :Prix d’achat ou de locationAssuranceEntretien et réparationsConsommation de carburant ou recharge Valeur de revente ou restitution en fin de LLD/LOA ➡ Les modèles réputés fiables et peu gourmands coûtent souvent moins cher sur le long terme.",
