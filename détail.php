...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture Suzuki Swift BVA-Offre 100KM/J (cat:MDAN)</p>
    <h2 class='lien1-texte'>Louer une voiture Suzuki Swift BVA-Offre 100KM/J (cat:MDAN)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/suzuki.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Toutes Catégories(MDAN)</h2>
        <p class='Voiture-description'>Suzuki Swift ou équivalent</p>
        <p class='detailVoiture-description'>Essence | BV Automatique | 4 passagers | 5 portes | 1 valise | 2 sacs | 6 Ch. Fisc. | A/C : Oui | GPS : Non </p> 
 ...
 <div class="titretexte">
       <div class="titretexte-contenu">
          <p>Services inclus <br>Assistance routière 24/7, Surcharge Gare, Assurance CDW et TP avec Franchise, TVA de 20%, Responsabilité Civile, Kilométrage limité à 100 Kms / Jour. <br> Franchises et cautions <br>Franchise accident: 14 400,00 DH, Franchise vol: 14 400,00 DH, Caution: 14 400 DH<br> Pré-requis <br>Âge minimum: 21 ans, Année de permis minimum: 1 an(s)</p>
 ...
 <div class="vehicule-voiture">
   <div class="vehicule-info">
      ...
      <p class="description">Gasoile|2 portes|2 bagages|Très rapide</p>
      <button class="reserver">RESERVER CE VEHICULE</button>
 </div>
 <div class="détails">
...
<!-- ligne 5-->
 <div class="vehicule-voiture">
   <div class="vehicule-info">
      ...
      <P><strong>Catégorie :</strong>EDGAR</P>
