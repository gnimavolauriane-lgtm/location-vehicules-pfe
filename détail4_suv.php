...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture KIA Seltos-Offre spéciale à 100 kms/jr (cat IFAN)</p>
    <h2 class='lien1-texte'>Louer une voiture KIA Seltos-Offre spéciale à 100 kms/jr (cat IFAN) </h2>
   </div>
