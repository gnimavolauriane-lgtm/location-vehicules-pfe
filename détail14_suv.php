...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Kia Sorento BVA-Offre spéciale à 100 Kms/jour (cat FFMN)</p>
    <h2 class='lien1-texte'>Louer une voiture  Kia Sorento BVA-Offre spéciale à 100 Kms/jour (cat FFMN)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image SUV/Kia Seltos.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(FFAN)</h2>
        <p class='Voiture-description'>KIA SORENTO BVA 4X4</p>
