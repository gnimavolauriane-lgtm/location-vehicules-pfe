...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture Citroën C-Elysée - Offre spéciale à 100 Kms /Jr(EDMN)</p>
    <h2 class='lien1-texte'>Louer une voiture Citroën C-Elysée (cat EDMN)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/citroen.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(EDMN)</h2>
        <p class='Voiture-description'>Citroën C Elysée</p>
        <p class='detailVoiture-description'>Gasoil | BV Manuelle | 5 passagers | 4 portes | 2 valises | 4 sacs | 6 Ch. Fisc. | A/C : Oui | GPS : Non </p>
