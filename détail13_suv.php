...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture MITSUBISHI L200 4x4-Offre en KM illimité (cat IQNR)</p>
    <h2 class='lien1-texte'>Louer une voiture MITSUBISHI L200 4x4-Offre en KM illimité (cat IQNR) </h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image SUV/Mitsubishi L200.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(IQNR)</h2>
        <p class='Voiture-description'>MITSUBISHI L200 4x4</p>
