...
<div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Khenifra </a>
    <h2 class='lien1-texte'>Khénifra – Évasion au cœur de la nature berbère</h2>
</div>
...
<div class="lieux-description">
  ...
  <div class="lieu-visite">
    <img src="image/parc.jpg" alt="Parc national de Khénifra">
    <div class="lieu-contenu">
      <h2>1. Parc national de Khénifra</h2>
      <p>
      Le parc national de Khénifra est une vaste réserve naturelle de plus de 200 000 hectares, qui protège une biodiversité exceptionnelle en plein cœur du Moyen Atlas. Forêts de cèdres, montagnes escarpées, plateaux verdoyants et vallées profondes forment un décor saisissant. Ce parc est le refuge de nombreuses espèces menacées, dont l’aigle royal, le singe magot et la hyène rayée.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>

  <div class="lieu-visite">
    <img src="image/lac.jpg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>2. Lac Aguelmam Azegza</h2>
      <p>
      À seulement 30 kilomètres de la ville, le lac Aguelmam Azegza est un petit paradis niché au cœur d’une forêt de chênes et de cèdres. Son eau limpide, aux reflets bleutés, est bordée de végétation luxuriante, ce qui en fait un lieu de détente privilégié. Les habitants comme les visiteurs s’y retrouvent pour pique-niquer, se baigner ou profiter d’un moment de calme au bord de l’eau.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
  ...
  <div class="lieu-visite">
    <img src="image/lac2.jpg" alt="Lac Aguelmam">
    <div class="lieu-contenu">
      <h2>3.Lac Aguelmam Ouiouane</h2>
      <p>
      Plus sauvage que le précédent, le lac Aguelmam Ouiouane se situe à environ 60 kilomètres de Khénifra, à une altitude de plus de 1 600 mètres. Ce joyau naturel, entouré de montagnes boisées, séduit par son isolement et son authenticité. On y accède souvent à pied ou à dos de mulet, ce qui ajoute une dimension d’aventure à la visite.
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>

  <div class="lieu-visite">
    <img src="image/lac1.jpg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>4.Lac Oum Rabie</h2>
      <p>
      Le lac Oum Rabie, issu de l’un des plus grands fleuves du Maroc, est un site à la fois symbolique et pittoresque. Situé au nord de Khénifra, il attire les familles, les pêcheurs et les passionnés de sports nautiques. Bordé de petits villages berbères, il reflète le mode de vie traditionnel de la région, entre agriculture et pastoralisme.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
  ...
  <div class="lieu-visite">
    <img src="image/foret.jpeg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>5. Forêt de cèdres d'Ajdir n-Izaïane</h2>
      <p>
      Cette forêt majestueuse est l’une des plus vastes cédraies du Maroc, couvrant une large portion des hauteurs de Khénifra. Les arbres centenaires y forment une voûte naturelle qui offre ombre et fraîcheur, créant une ambiance presque mystique. C’est un lieu prisé pour les balades à pied, à vélo ou même à cheval.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
  ...
  <div class="lieu-visite">
    <img src="image/bebere.jpg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>6. Belvédère d’Ito</h2>
      <p>
      Le belvédère d’Ito offre l’une des vues les plus spectaculaires sur la région de Khénifra. Perché sur les hauteurs, ce point d’observation permet d’embrasser d’un regard les montagnes du Moyen Atlas, les forêts à perte de vue et les vallées encaissées. C’est un lieu rêvé pour les photographes, les peintres ou tout simplement les rêveurs.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
