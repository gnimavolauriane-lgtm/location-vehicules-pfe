...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "PREMIUM"  </a> >
     <p class='lien1-description'>Louer une voiture CITROEN C4X BVA</p>
    <h2 class='lien1-texte'>Location CITROEN C4X BVA- Offre en KM illimité (cat SPAD)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image Premium/Citroen e-C4.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie PREMIUM(SPAD)</h2>
        <p class='Voiture-description'>CITROEN C4X BVA</p>
        <p class='detailVoiture-description'>Gasoil|BV Automatique|5 passagers|5 portes|2 valises |4 Sacs|A/C: Oui|GPS: Non </p> 
