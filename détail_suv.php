...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Citadine C3 </p>
    <h2 class='lien1-texte'>Louer une voiture Citadine C3 </h2>
   </div>
 ...
 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      ...
      <div class="detailVoiture-droite">
        <h2>Catégorie SUV</h2>
        <p class='Voiture-description'>Citadine C3 </p>
 ...
 <div class="titretexte">
       <div class="titretexte-contenu">
          <p>Services inclus <br>Kilométrage limité à 100 Kms / Jour, TVA de 20%, Responsabilité Civile, Assistance routière 24/7, Surcharge Gare, Assurance CDW et TP avec Franchise.  <br> Franchises et cautions <br>Franchise accident: 14 400,00 DH, Franchise vol: 14 400,00 DH, Caution: 14 400 DH<br> Pré-requis <br>Âge minimum: 21 ans, Année de permis minimum: 1 an(s)</p>
