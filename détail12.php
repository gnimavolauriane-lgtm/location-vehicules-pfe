...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture OPEL CROSSLAND (CXMD)</p>
    <h2 class='lien1-texte'>Louer une voiture OPEL CROSSLAND (CXMD)</h2>
   </div>
 ...
 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      ...
      <div class="detailVoiture-droite">
        <h2>Citadine(CXMD)</h2>
        <p class='Voiture-description'>OPEL CROSSLAND (CXMD)</p>
        <p class='detailVoiture-description'>Gasoil | BV Manuelle | 5 passagers | 5 portes | 3 valises | 4 sacs | 9 Ch. Fisc. | A/C : Oui | GPS : Non </p>
