...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture GEELY GX3 PRO (cat:ECMR)</p>
    <h2 class='lien1-texte'>Louer une voiture GEELY GX3 PRO (cat:ECMR)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/gx3.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(ECMR)</h2>
        <p class='Voiture-description'>GEELY GX3 PRO</p>
        <p class='detailVoiture-description'>Essence | BV Manuelle | 5 passagers | 5 portes | 2 valises | 4 sacs | 9 Ch. Fisc. | A/C : Oui | GPS : Non </p>
