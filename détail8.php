...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture suzuki Jimny (cat:EGAR)</p>
    <h2 class='lien1-texte'>Louer une voiture suzuki Jimny (cat:EGAR)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/jimny.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(EGAR)</h2>
        <p class='Voiture-description'>suzuki Jimny</p>
        <p class='detailVoiture-description'>Essence | BV Automatique | 4 passagers | 4 portes | 1 valises | 2 sacs | 8 Ch. Fisc. | A/C : Oui | GPS : Non </p>
