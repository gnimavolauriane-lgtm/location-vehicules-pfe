...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture peugeot 308 BVA (cat:CDAR)</p>
    <h2 class='lien1-texte'>Louer une voiture peugeot 308 BVA (cat:CDAR)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/peugeot 308.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(CDAR)</h2>
        <p class='Voiture-description'>Peugeot 308</p>
        <p class='detailVoiture-description'>Gasoil | BV Automatique| 5 passagers | 5 portes | 2 valises | 4 sacs | 6 Ch. Fisc. | A/C : Oui | GPS : Non </p>
