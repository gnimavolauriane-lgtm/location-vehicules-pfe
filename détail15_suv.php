...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Alfa Romeo Stelvio BVA-Offre en KM illimité (cat FXAD)</p>
    <h2 class='lien1-texte'>Louer une voiture Alfa Romeo Stelvio BVA (cat FXAD)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image SUV/alfa.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(FXAD)</h2>
        <p class='Voiture-description'>Alfa Romeo Stelvio</p>
