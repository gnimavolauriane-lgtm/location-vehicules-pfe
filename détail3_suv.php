...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture KIA Sportage-Offre spéciale à 100 kms/jr (cat IXAD)</p>
    <h2 class='lien1-texte'>Louer une voiture KIA Sportage-Offre spéciale à 100 kms/jr (cat IXAD) </h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image compacte/Kia Sportage.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(IXAD)</h2>
        <p class='Voiture-description'>KIA Sportage</p>
