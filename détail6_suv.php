...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture KIA Sorento-Offre spéciale à 100 kms/jr (cat FFMN)</p>
    <h2 class='lien1-texte'>Louer une voiture KIA Sorento-Offre spéciale à 100 kms/jr (cat FFMN) </h2>
   </div>
 ...
 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      ...
      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(FFMN)</h2>
        <p class='Voiture-description'>KIA Sorento</p>
