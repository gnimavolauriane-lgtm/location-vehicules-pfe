...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "COMPACT"  </a> >
     <p class='lien1-description'>Louer une voiture Volkswagen Golf</p>
    <h2 class='lien1-texte'>Louer une voiture Volkswagen Golf</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image compacte/Volkswagen Golf.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie COMPACT</h2>
        <p class='Voiture-description'>Volkswagen Golf</p>
        <p class='detailVoiture-description'>Essence|BV Automatique|5 passagers||5 portes|2 valises|4 Sacs| 6 Ch. Fisc. | A/C : Oui | GPS : Oui </p> 
