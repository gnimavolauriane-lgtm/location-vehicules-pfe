...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture Peugeot Boxer L2H2 8-10m3-Offre à 100Kms/J cat(VGIW)</p>
    <h2 class='lien1-texte'>Location Peugeot Boxer L2H2</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image utilitaire/peugeot boxer.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VGIW)</h2>
        <p class='Voiture-description'>Peugeot Boxer L2H2</p>
        <p class='detailVoiture-description'>Gasoil|BV Manuelle|3 passagers|4 portes|9 Ch.Fisc|Volume 10m³|A/C: Oui|GPS: Non </p> 
