...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Toyota PRADO 4X4-Offre spéciale à 100 kms/jr (cat FFMD)</p>
    <h2 class='lien1-texte'>Louer une voiture Toyota PRADO 4X4-Offre spéciale à 100 kms/jr (cat FFMD) </h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image SUV/Toyota Prado.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(FFMD)</h2>
        <p class='Voiture-description'>Toyota PRADO 4X4</p>
