...
<div class="lieux-description">
  ...
  <div class="lieu-visite">
    <img src="image/ouzoud.jpg" alt="Parc national de Khénifra">
    <div class="lieu-contenu">
      <h2>1. Cascades d'Ouzoud</h2>
      <p>
      Situées à environ 36 km d'Azilal, les cascades d'Ouzoud sont parmi les plus impressionnantes du Maroc, avec une chute d'eau de 110 mètres. Entourées de végétation luxuriante, elles offrent des panoramas spectaculaires et des possibilités de baignade dans les bassins naturels. Les visiteurs peuvent également observer des singes berbères et profiter de balades en bateau.
      </p>
  ...
  <div class="lieu-visite">
    <img src="image/Lac de Bin.jpg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>2. Lac Bin El Ouidane</h2>
      <p>
      À environ 45 km d'Azilal, le lac Bin El Ouidane est un réservoir artificiel bordé par les montagnes de l'Atlas. C'est un lieu idéal pour les activités nautiques telles que le kayak, le paddle et la pêche. Les rives du lac sont également propices aux pique-niques et à la détente, offrant une vue imprenable sur les paysages environnants.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
  ...
  <div class="lieu-visite">
    <img src="image/source.jpg" alt="Lac Aguelmam">
    <div class="lieu-contenu">
      <h2>3. Gorges de l'Oum Er-Rbia</h2>
      <p>
      Les gorges de l'Oum Er-Rbia, situées à proximité d'Azilal, sont un site naturel impressionnant où le fleuve Oum Er-Rbia a creusé des canyons profonds à travers les montagnes. Ce lieu est parfait pour les amateurs de randonnée et d'escalade, offrant des vues spectaculaires et une immersion totale dans la nature sauvage.</p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>

  <div class="lieu-visite">
    <img src="image/vallée.jpg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>4. Vallée d'Aït Bouguemez</h2>
      <p>
      Surnommée la "Vallée Heureuse", Aït Bouguemez est une vallée verdoyante entourée de montagnes, réputée pour ses paysages pittoresques et ses villages berbères traditionnels. Les visiteurs peuvent y faire des randonnées, découvrir les anciennes kasbahs et s'immerger dans la culture locale en séjournant chez l'habitant.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
  ...
  <div class="lieu-visite">
    <img src="image/zaouiat.jpeg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>5.Zaouiat Ahansal </h2>
      <p>
      Ce village berbère, situé près d'Azilal, est connu pour sa beauté naturelle et son importance spirituelle. Entouré de montagnes et de vallées, il offre des opportunités de randonnée et permet de découvrir la culture et les traditions des habitants locaux.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
  ...
  <div class="lieu-visite">
    <img src="image/musée.jpg" alt="Lac Aguelmam Azegza">
    <div class="lieu-contenu">
      <h2>6. Musée du Géoparc M'Goun</h2>
      <p>
      Situé à Azilal, le musée du Géoparc M'Goun propose une immersion dans l'histoire géologique de la région. À travers des expositions sur les fossiles, les dinosaures et les formations rocheuses, les visiteurs peuvent comprendre l'évolution de cette zone montagneuse et son importance dans le contexte géologique mondial.
      </p>
      <a href="#" class="lire-suite">Suite de l'article &gt;</a>
    </div>
  </div>
