...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture EXMN/OPEL Corsa ou equivalent(EXMN)</p>
    <h2 class='lien1-texte'>Louer une voiture EXMN/OPEL Corsa ou equivalent(EXMN)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/opel.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(EXMN)</h2>
        <p class='Voiture-description'>EXMN/OPEL Corsa ou equivalent</p>
        <p class='detailVoiture-description'>Gasoil | BV Manuelle | 5 passagers | 5 portes | 2 valises | 4 sacs | 6 Ch. Fisc. | A/C : Oui | GPS : Non </p>
