...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture KIA K2500 Multiservices L2H2 -Offre à 100Kms/Jour (cat:VGXW)</p>
    <h2 class='lien1-texte'>Louer une voiture KIA K2500 Multiservices L2H2  -Offre à 100Kms/Jour (cat:VGXW)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image utilitaire/L2H2.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VGXW)</h2>
        <p class='Voiture-description'>KIA K2500 Multiservices L2H2</p>
        <p class='detailVoiture-description'>Gasoile|BV Manuelle|3 passagers|3 portes|10 Ch.Fisc |Volume 9m³|A/C:Oui|GPS:Non </p> 
