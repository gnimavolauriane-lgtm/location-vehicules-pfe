...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "MINIBUS"  </a> >
     <p class='lien1-description'>Louer une voiture KIA Carnival</p>
    <h2 class='lien1-texte'>Louer une voiture KIA Carnival 8PAX- Offre en KM illimité (cat FVAD)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image minibus/carnival.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie MINIBUS(FVAD)</h2>
        <p class='Voiture-description'>KIA Carnival</p>
        <p class='detailVoiture-description'>Gasoil|BV Automatique|8 passagers|4 portes|3 valises |6 Sacs|9 Ch.Fisc|A/C: Oui|GPS: Non </p> 
