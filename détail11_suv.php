...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "SUV"  </a> >
     <p class='lien1-description'>Louer une voiture Suzuki Jimny-Offre en KM illimité (cat EGAR)</p>
    <h2 class='lien1-texte'>Louer une voiture Suzuki Jimny-Offre en KM illimité (cat EGAR) </h2>
   </div>
 ...
 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      ...
      <div class="detailVoiture-droite">
        <h2>Catégorie SUV(EGAR)</h2>
        <p class='Voiture-description'>Suzuki Jimny 4X4</p>
