...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "MINIBUS"  </a> >
     <p class='lien1-description'>Louer une voiture KIA Carens 6PAX 8VA</p>
    <h2 class='lien1-texte'>Louer une voiture KIA Carens 6PAX 8VA- Offre en KM illimité (cat IVMR)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image minibus/KIA Carens.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie MINIBUS(IVMR)</h2>
        <p class='Voiture-description'>KIA Carens</p>
        <p class='detailVoiture-description'>Gasoil|BV Automatique|6 passagers|5 portes|2 valises |4 Sacs|6 Ch.Fisc|A/C: Oui|GPS: Non </p> 
 ...
 <div class="vehicule-voiture">
   ...
   <img src="image/image minibus/KIA Carens.jpg" alt="" class="voiture-image">
      ...
      <p class="description">Gasoil|BV Automatique|6 passagers| 5 portes|2 valises|4 Sacs| 6 Ch. Fisc. | A/C : Oui | GPS : Oui</p>
 ...
 <div class="vehicule-voiture">
   <div class="vehicule-info">
      <img src="image/image premium/AWD.jpeg" alt="" class="voiture-image">
      <p class="vehicule-nom">Volkswagen Touareg AWD</p>
