...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "UTILITAIRE"  </a> >
     <p class='lien1-description'>Louer une voiture Peugeot Boxer L3H2 10-12m3 cat(VJIW)</p>
    <h2 class='lien1-texte'>Location Peugeot Boxer L3H2 10-12m3</h2>
   </div>
 ...
 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      ...
      <div class="detailVoiture-droite">
        <h2>Catégorie UTLITAIRE(VJIW)</h2>
        <p class='Voiture-description'>Peugeot Boxer L3H2</p>
        <p class='detailVoiture-description'>Gasoil|BV Manuelle|3 passagers|4 portes|9 Ch.Fisc|Volume 12m³|A/C: Oui|GPS: Non </p> 
