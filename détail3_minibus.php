...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "MINIBUS"  </a> >
     <p class='lien1-description'>Louer une voiture Renault Trafic Combi</p>
    <h2 class='lien1-texte'>Louer une voiture Renault Trafic Combi 9PAX- Offre en KM illimité (cat FVMR)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/image minibus/minibus.jpg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Catégorie MINIBUS(FVMR)</h2>
        <p class='Voiture-description'>Renault Trafic Combi 9Pax</p>
        <p class='detailVoiture-description'>Gasoil|BV Manuelle|9 passagers|4 portes|4 valises |8 Sacs|6 Ch.Fisc|A/C: Oui|GPS: Non </p> 
