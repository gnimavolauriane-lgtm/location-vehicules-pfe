...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <a href="#" class="lien1">Découvrez notre gamme de voiture de location "Citadines"  </a> >
     <p class='lien1-description'>Louer une voiture Dacia Sandero Streetway BVM (cat ECMN)</p>
    <h2 class='lien1-texte'>Louer une voiture Dacia Sandero Streetway BVM(cat ECMN)</h2>
   </div>

 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      <div class='detailVoiture-gauche'>
         <img src="image/dacia.jpeg" alt="">
      </div>

      <div class="detailVoiture-droite">
        <h2>Citadine(ECMN)</h2>
        <p class='Voiture-description'>Dacia Sandero Streetway BVM(cat ECMN)</</p>
        <p class='detailVoiture-description'>Essence | BV Automatique | 5 passagers | 5 portes | 2 valises | 4 sacs | 8 Ch. Fisc. | A/C : Oui | GPS : Non </p>
 ...
 <div class="titretexte">
       <div class="titretexte-contenu">
          <p>Services inclus <br>Kilométrage limité à 100 Kms / Jour, TVA de 20%, Responsabilité Civile, Assistance routière 24/7, Surcharge Gare, Assurance CDW et TP avec Franchise. <br> Franchises et cautions <br>Franchise accident: 15 600,00 DH, Franchise vol: 15 600,00 DH, Caution: 15 600 DH<br> Pré-requis <br>Âge minimum: 21 ans, Année de permis minimum: 1 an(s)</p>
