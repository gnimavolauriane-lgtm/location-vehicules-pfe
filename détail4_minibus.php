...
<body>
   ...
   <div class="lien1-contenu">
    ...
    <h2 class='lien1-texte'>Location Renault Trafic Combi- Offre spécial à 100 Kms/Jr (cat FVMN)</h2>
   </div>
 ...
 <div class="detailVoiture">
   <div class='detailVoiture-contenu'>
      ...
      <div class="detailVoiture-droite">
        <h2>Catégorie MINIBUS(FVMN)</h2>
        <p class='Voiture-description'>Renault Trafic Combi</p>
